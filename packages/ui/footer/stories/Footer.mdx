...
<Unstyled>
	<Page.Tabs
		title="Footer"
		subtitle="The Footer component serves as the bottom section of a web page, it contains information like copyright notices, contact details, and links to important resources."
		status="ready"
	>
