...
`;function Group_createMdxContent(props){return(0,jsx_runtime.jsxs)(docs_src.wn,{border:!0,style:{paddingRight:0,paddingLeft:0},children:[(0,jsx_runtime.jsx)("p",{children:"Here's an example of the group varaition for the table"}),(0,jsx_runtime.jsx)(docs_src.lN,{wrapper:!0,children:(0,jsx_runtime.jsx)(TableExample,{isGrouped:!0})}),(0,jsx_runtime.jsx)(docs_src.YK,{language:"js",children:code})]})}const Group=function Group_MDXContent(props={}){const{wrapper:MDXLayout}=Object.assign({},(0,lib.RP)(),props.components);return MDXLayout?(0,jsx_runtime.jsx)(MDXLayout,Object.assign({},props,{children:(0,jsx_runtime.jsx)(Group_createMdxContent,props)})):Group_createMdxContent()},generalCode=(props="")=>dedent_default()`
                    ...
                    <TableBody>
                        {rows?.map((record, index) => (
                            ...
                            >
                                ...
                                <TableCell>
                                    <Tag colorScheme={"Published" === record.tag ? "blue" : "default"}>
                                        {record.tag}
                                    </Tag>
                                </TableCell>
                                <TableCell>{record.submission}</TableCell>
...
`;function TabExamples_createMdxContent(props){return(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:["\n","\n","\n",(0,jsx_runtime.jsxs)(docs_src.wn,{style:{paddingTop:30},children:[(0,jsx_runtime.jsx)("p",{children:"A basic table example with actions"}),(0,jsx_runtime.jsx)(docs_src.lN,{wrapper:!0,children:(0,jsx_runtime.jsx)(TableExample,{hasToolbar:!1})}),(0,jsx_runtime.jsx)(docs_src.YK,{language:"js",children:generalCode()})]}),"\n",(0,jsx_runtime.jsx)(docs_src.wn,{title:"State",style:{paddingTop:0},children:(0,jsx_runtime.jsxs)(docs_src.ij,{children:[(0,jsx_runtime.jsx)("div",{label:"Stripe",value:"stripe",children:(0,jsx_runtime.jsx)(Stripe,{})}),(0,jsx_runtime.jsx)("div",{label:"Selection",value:"selection",children:(0,jsx_runtime.jsx)(Selection,{})}),(0,jsx_runtime.jsx)("div",{label:"Drag",value:"drag",children:(0,jsx_runtime.jsx)(Drag,{})}),(0,jsx_runtime.jsx)("div",{label:"Toolbar",value:"toolbar",children:(0,jsx_runtime.jsx)(Toolbar,{})}),(0,jsx_runtime.jsx)("div",{label:"Group",value:"grouped",children:(0,jsx_runtime.jsx)(Group,{})})]})})]})}const TabExamples=function TabExamples_MDXContent(props={}){const{wrapper:MDXLayout}=Object.assign({},(0,lib.RP)(),props.components);return MDXLayout?(0,jsx_runtime.jsx)(MDXLayout,Object.assign({},props,{children:(0,jsx_runtime.jsx)(TabExamples_createMdxContent,props)})):TabExamples_createMdxContent()};function ReactTable_createMdxContent(props){return docs_src.YW||_missingMdxReference("Page",!1),docs_src.YW.Tabs||_missingMdxReference("Page.Tabs",!0),(0,jsx_runtime.jsx)(dist.di,{children:(0,jsx_runtime.jsxs)(docs_src.YW.Tabs,{title:"Table",subtitle:"Tables are used to present structured data in a tabular format.",status:"ready",children:[(0,jsx_runtime.jsx)("div",{id:"usage",label:"Usage",children:(0,jsx_runtime.jsx)(TabUsage,{})}),(0,jsx_runtime.jsx)("div",{id:"code",label:"Code",children:(0,jsx_runtime.jsx)(TabCode,{})}),(0,jsx_runtime.jsx)("div",{id:"examples",label:"Examples",children:(0,jsx_runtime.jsx)(TabExamples,{})})]})})}function _missingMdxReference(id,component){throw new Error("Expected "+(component?"component":"object")+" `"+id+"` to be defined: you likely forgot to import, pass, or provide it.")}const Table_stories={title:"SUI/Components/Modules/Table",parameters:{layout:"fullscreen",docs:{page:function ReactTable_MDXContent(props={}){const{wrapper:MDXLayout}=Object.assign({},(0,lib.RP)(),props.components);return MDXLayout?(0,jsx_runtime.jsx)(MDXLayout,Object.assign({},props,{children:(0,jsx_runtime.jsx)(ReactTable_createMdxContent,props)})):ReactTable_createMdxContent()}}}},Table_stories_tableItems=(0,utils_src.ln)(records,5),Table=({...args})=>{const[tempRows,setTempRows]=(0,react.useState)([]),[rows,setRows]=(0,react.useState)([]),[page,setPage]=(0,react.useState)(1);(0,react.useEffect)(()=>{setRows(Table_stories_tableItems?.[0]),setTempRows(Table_stories_tableItems?.[0])},[]),(0,react.useEffect)(()=>{setRows(Table_stories_tableItems?.[page-1])},[page]);return(0,jsx_runtime.jsx)("div",{className:"sui-layout sui-layout--horizontal sui-layout--vertical",children:(0,jsx_runtime.jsx)("div",{className:"sui-layout__content",children:(0,jsx_runtime.jsxs)(table_src.XI,{...args,stickyCols:!0,_htmlProps:{disabled:!0},onAction:(actionType,data)=>{let dRows=[...rows];switch(actionType){case"bulk-action":case"apply-filters":break;case"sort-rows":dRows=data.map(id=>rows.find(item=>item.id===id));break;case"search-items":dRows=tempRows.filter(item=>item.title.includes(data)),dRows=""!==data?dRows:tempRows;break;case"sort-columns":const{column,order}=data;dRows.sort((a,b)=>"desc"===order?b[column]?.localeCompare(a[column]):a[column]?.localeCompare(b[column]))}setRows([...dRows])},children:[(0,jsx_runtime.jsx)(table_src.nd,{children:(0,jsx_runtime.jsxs)(table_src.Hj,{actions:()=>null,children:[(0,jsx_runtime.jsx)(table_src.nA,{isHeading:!0,isSortable:!1,isPrimary:!0,id:"id",children:"ID"}),(0,jsx_runtime.jsx)(table_src.nA,{isHeading:!0,isSortable:!0,id:"title",children:"Form name"}),(0,jsx_runtime.jsx)(table_src.nA,{isHeading:!0,id:"tag",isSortable:!0,children:"Status"}),(0,jsx_runtime.jsx)(table_src.nA,{isHeading:!0,id:"submission",isSortable:!0,children:"Last Submission"})]})}),(0,jsx_runtime.jsx)(table_src.BF,{children:rows?.map((record,index)=>(0,jsx_runtime.jsxs)(table_src.Hj,{id:record.id,isExpandable:record?.props?.isExpandable,expandableContent:record?.props?.expandableContent,status:record?.status,actions:({id,content})=>((_id,content)=>(0,jsx_runtime.jsxs)("div",{style:{alignItems:"center",display:"flex",justifyContent:"end"},children:[(0,jsx_runtime.jsx)(button_src.$,{icon:"Edit",colorScheme:"black",type:"tertiary",isSmall:!0,iconOnly:!0,children:"Edit"}),(0,jsx_runtime.jsx)(button_src.$,{icon:"Settings",colorScheme:"black",type:"tertiary",isSmall:!0,iconOnly:!0,children:"Settings"}),content]}))(0,content),children:[(0,jsx_runtime.jsx)(table_src.nA,{children:(0,jsx_runtime.jsxs)("strong",{children:["#",record.id]})}),(0,jsx_runtime.jsx)(table_src.nA,{isTrim:!0,children:(0,jsx_runtime.jsx)("strong",{children:record.title})}),(0,jsx_runtime.jsx)(table_src.nA,{children:(0,jsx_runtime.jsx)(tag_src.v,{colorScheme:"Published"===record.tag?"blue":"default",children:record.tag})}),(0,jsx_runtime.jsx)(table_src.nA,{children:record.submission})]},index))}),(0,jsx_runtime.jsx)(table_src.Gg,{children:(0,jsx_runtime.jsx)(table_src.Hj,{id:"0",children:(0,jsx_runtime.jsx)(table_src.nA,{children:(0,jsx_runtime.jsx)(pagination_src.d,{limit:5,numberOfItems:records.length,page,onChange:setPage})})})})]})})})};Table.args={allowCheck:!0,isDraggable:!0,hasToolbar:!0,ariaLabel:"",bulkActions:[{id:"delete",label:"Delete"},{id:"publish",label:"Publish"}],showFiltersBtn:!0,showToggleBtn:!1,toggleBtnProps:{label:"Show updates only",onClick:()=>{}},filters:[{id:"sort-by",type:"select",title:"Sort By",value:"id",props:{id:"sort-by",isSmall:!0,options:[{id:"id",label:"ID"},{id:"form-name",label:"Form name"},{id:"status",label:"Status"},{id:"last-submission",label:"Last Submission"}]}},{id:"form-name",type:"select",title:"Form name",value:"option-1",props:{id:"form-name",isSmall:!0,options:records.map(record=>({id:record.id,label:record.title}))}},{id:"status",type:"select",title:"Status",value:"1",props:{id:"sort-by",isSmall:!0,options:[{id:"draft",label:"Draft"},{id:"published",label:"Published"}]}},{id:"last-submission",type:"text",title:"Last Submission",value:"1",props:{isSmall:!0}}],filtersPopover:!0,isStripped:!1},Table.argTypes={ariaLabel:{name:"Aria Label",control:{type:"text"}},showFiltersBtn:{name:"Show Filter Button",control:{type:"boolean"},if:{arg:"hasToolbar",eq:!0}},showToggleBtn:{name:"Show Toggle Button",control:{type:"boolean"},if:{arg:"showFiltersBtn",eq:!1}},toggleBtnProps:{name:"Toggle Button Props",control:{type:"object"},if:{arg:"showToggleBtn",eq:!0}},allowCheck:{name:"Allow select",control:"boolean"},isDraggable:{name:"Allow drag",control:"boolean"},hasToolbar:{name:"Toolbar",control:"boolean"},bulkActions:{name:"Bulk Actions"},filters:{name:"Filters",if:{arg:"hasToolbar",eq:!0}},filtersPopover:{name:"Filter Popover",control:{type:"boolean"},if:{arg:"hasToolbar",eq:!0}},isStripped:{name:"Stripe",control:{type:"boolean"}}};const __namedExportsOrder=["Table"]}}]);
//# sourceMappingURL=ui-table-stories-Table-stories.5424e2a5.iframe.bundle.js.map