...
<Meta title="SUI/Components/Advanced/Tabs" of={TabsStories} />

<Unstyled>
  <Page.Tabs title="Tabs" subtitle="Organize the similar content with the tabs that helps users to move between the related content." status="ready">
