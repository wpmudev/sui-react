...
<Meta title="SUI/Components/Advanced/Date Picker" of={DatePickerStories} />

<Unstyled>
  <Page.Tabs title="Date Picker" subtitle="The Date Picker component enable users to select a specific date or a range of dates." status="ready">
