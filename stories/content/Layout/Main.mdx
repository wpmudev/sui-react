...
<Page.Simple
	...
	subtitle={
		<>
			...
			. Choose between full-width (100% wide all the time) and contained (it
			has a maximum width) content.
		</>
	}
	status="ready"
>
	...
	>
		...
		<p>
			Remember skipping the <Code>sui-layout--vertical</Code> class for
