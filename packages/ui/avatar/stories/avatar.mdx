...
<Meta title="SUI/Components/Core/Avatar" of={AvatarStories} />

<Unstyled>
  <Page.Tabs title="Avatar" subtitle="An avatar is a thumbnail that represents a user or organization on the SUI platform." status="ready">
