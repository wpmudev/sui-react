...
<Unstyled>
	<Page.Tabs
		title="Grid"
		subtitle="The Grid is composed of two fundamental components: Row and Column. It empowers you to create layouts and align content with precision on your web page"
		status="ready"
	>
