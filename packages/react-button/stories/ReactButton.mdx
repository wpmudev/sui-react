...
<Page.Tabs
	...
	subtitle={
		<>
			Use buttons for interface actions, from saving some settings to triggering a modal. They come in different variations based on the design needs for a better user experience.
		</>
	}
	status="draft"
>
