...
import NotificationLocation from "../images/location.svg"
...
<Section title="2. Toast Notifications">
    ...
    <h2 style={{ paddingTop: 15 }}> Where and how to display? </h2>
    <img src={NotificationLocation} alt="Notification Display Location" />
</Section>
