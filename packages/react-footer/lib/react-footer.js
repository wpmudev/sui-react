...
import { Menu } from '@wpmudev/react-menu';
		...
		<div className="sui-footer">
			<div className="sui-footer__group">
				<div className="sui-footer__block">
					<p>Check our <a href="#" target="_blank" rel="nofollow">All in One WordPress Toolkit</a></p>
				</div>
				<div className="sui-footer__block">
					<p>To get the most out of the plugin, <a href="#" target="_blank" rel="nofollow">see the Help section</a></p>
				</div>
			</div>
			<div className="sui-footer__group">
				<div className="sui-footer__block">
