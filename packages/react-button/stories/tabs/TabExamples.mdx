...
<Section contained={true} style={{ paddingTop: 0 }}>
	<p>Below is the default form of a button, used for most cases; it is not impactful enough to represent the primary action in a container but necessary in some scenarios.</p>
