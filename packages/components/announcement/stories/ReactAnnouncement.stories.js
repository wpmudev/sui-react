...
import { Announcement as SuiAnnouncement } from "../src"
...
export default {
	title: "SUI/Components/Advanced/Announcement",
		...
		<Fragment>
			<div className="sui-layout">
				<SuiAnnouncement isVisible={true} {...props}>
					<strong>Big Day!</strong> Display this banner for general announcement
					and upsells for all plugins.
				</SuiAnnouncement>
			</div>
